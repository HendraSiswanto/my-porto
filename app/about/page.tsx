export default function AboutPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 py-20">
      ...
      <h1 className="flex justify-center text-4xl font-bold mb-12">
        About Me
      </h1>
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            components, clear UI structure, and maintainable code.
            I enjoy turning ideas into real products that feel smooth and
            intuitive to use.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            <span className="font-medium">internship or junior frontend role</span>{" "}
